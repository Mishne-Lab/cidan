    ...
    for file in ["kdan", "File5", "File6", "File1", "File2", "File3", "File4", ]:
        for background in ["_median_mean", "_max", "_median_max", "_median_median",
            ...
            if background == "_eigennorm":
                background_img = os.path.join(data_4, [x for x in os.listdir(data_4) if
                                                       file in x][0],
                ...
                background_img = os.path.join(
                    ...
                    file + background + ".npy")
            data_1_path = os.path.join(data_1, folders_1[0])
            # for folder in folders_1:
            #     multiblob_special.create_graph(bg_path=background_img, shape=None, e_dir="",
